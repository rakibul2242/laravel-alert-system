<div class="max-w-2xl mx-auto space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-none">
        <form wire:submit.prevent="sendMail" class="space-y-6">
            @if ($successMessage)
                <div class="text-green-800 bg-green-100 border border-green-300 rounded px-4 py-3 dark:text-green-300 dark:bg-green-900 dark:border-green-700" role="alert">
                    {{ $successMessage }}
                </div>
            @endif
            ...
            <div class="flex items-center justify-between">
                ...
                <div wire:loading wire:target="sendMail" class="ml-4">
                    <svg class="animate-spin h-6 w-6 text-blue-600 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24">
