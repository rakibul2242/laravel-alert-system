      ...
      <form action="{{ route('posts.store') }}" method="POST" class="space-y-8">
        ...
        <div>
          ...
          <textarea
            ...
            class="w-full rounded-md border border-emerald-600 bg-slate-900 px-5 py-3 text-slate-100 placeholder-slate-500
                   focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400 focus:outline-none transition resize-none"
          ></textarea>
        </div>

        <button
          type="submit"
          class="w-full bg-emerald-600 hover:bg-emerald-700 transition rounded-md py-4 font-semibold text-slate-100
